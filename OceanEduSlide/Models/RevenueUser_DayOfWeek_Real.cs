...
{
    public class RevenueUser_DayOfWeek_Real
    {
        ...
        [Display(Name = "Chỉ tiêu doanh số hoàn thành"),DisplayFormat(DataFormatString = "{0:N0}đ"),RegularExpression(@"^\d*[1-9]\d*$", ErrorMessage = "Giá trị phải là số nguyên dương.")]
        ...
        public RevenueUser_DayOfWeek_Real()
        {
