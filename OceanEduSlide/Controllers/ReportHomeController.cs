            ...
            if (model.OfficeId != null)
            {
               ...
               .ToDictionary(
                ...
                foreach (var month in listMonth)
                {
                    ...
                    tongSoThangDKNam += tongSoThangDKNam;
